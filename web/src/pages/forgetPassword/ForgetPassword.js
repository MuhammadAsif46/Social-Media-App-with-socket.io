  ...
  return (
    <div className="container-login">
      <div className="first-child">
        ...
        <p className="app-text">Enter the email address associated  with your <br />account. Click Next button and  we'll send <br />you a page to reset your password.</p>
      </div>
      ...
      <div className="second-child">
        <form id="loginForm" onSubmit={ForgetPasswordSubmitHandler}>
          ...
          <button class="btn btn-primary loginBtn" type="submit"> Next </button>
          <br />

          <div className="signupBtn">
            <Link class="btn btn-secondary backBtn" to={'/login'}>Back</Link>
          </div>
